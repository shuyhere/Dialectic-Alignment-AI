...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument(
            "--output_dir", type=str, default="./checkpoint/my_experiments", help="LLM_models are saved here"
        )
        self.parser.add_argument(
            "--train_data",
            nargs="+",
    ...
    def print_options(self, opt):
        ...
        model_dir = os.path.join(opt.output_dir, "LLM_models")
        if not os.path.exists(model_dir):
            os.makedirs(os.path.join(opt.output_dir, "LLM_models"))
